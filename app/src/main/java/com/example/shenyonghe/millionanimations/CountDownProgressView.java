...
/**
 * Created by shenyonghe on 2018/1/10.
 */
    ...
    public CountDownProgressView(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null) {
            ...
            if (typedArray.hasValue(R.styleable.CountDownProgress_circFrameColor)) {
                ...
                //没有这个属性索引 默认是深灰色
                circFrameColor = typedArray.getColor(R.styleable.CountDownProgress_circFrameColor, Color.parseColor("#ffffff"));
            }
    ...
    private Runnable progressChangeTask = new Runnable() {
        ...
        public void run() {
            ...
            if (progress >= 0 && progress <= COUNT) {
                ...
                invalidate();
                postDelayed(progressChangeTask, timeMillis / COUNT);
            } else
